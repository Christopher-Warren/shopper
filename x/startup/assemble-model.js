...
export function assembleModel({ mock, cartStorage, shopifyDomain, shopifyStorefrontAccessToken, }) {
    //
    ...
    const model = {
        reader,
        getters,
        actions: objectMap(prepareActions({ state, checkout, getters, update }), value => asyncHitch(value, { after: async () => {
